                    ...
                    <div class="sticky top-0 z-50 overflow-hidden ">
                        ...
                        <div class="px-6 pb-6 mt-6 border-t border-gray-300 dark:border-gray-400 ">
                            <div class="flex flex-wrap items-center mt-6">
                                ...
                                <h2 class="text-lg font-bold text-gray-700 dark:text-gray-400">Evio Gratis</h2>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="lg:pl-20">
                        <div class="mb-8 [&>ul]:list-disc [&>ul]:ml-4">
                            ...
                            <p class="inline-block mb-6 text-4xl font-bold text-gray-700 dark:text-gray-400 ">
                                <span>{{Number::currency($product->price,'COL')}}</span>
                        ...
                        <div class="w-32 mb-8 ">
                            ...
                            <div class="relative flex flex-row w-full h-10 mt-6 bg-transparent rounded-lg">
                                <button wire:click="decrementCantidad"
                                    class="w-20 h-full text-gray-600 bg-gray-300 rounded-l outline-none cursor-pointer dark:hover:bg-gray-700 dark:text-gray-400 hover:text-gray-700 dark:bg-gray-900 hover:bg-gray-400">
                                    <span class="m-auto text-2xl font-thin">-</span>
                                </button>
                                <input type="number" readonly wire:model="cantidad"
                                    class="flex items-center w-full font-semibold text-center text-gray-700 placeholder-gray-700 bg-gray-300 outline-none dark:text-gray-400 dark:placeholder-gray-400 dark:bg-gray-900 focus:outline-none text-md hover:text-black"
                                    placeholder="1">
                                <button wire:click="incrementCantidad"
                        ...
                        <div class="flex flex-wrap items-center gap-4">
                            <button  wire:click="agregarAlCarrito({{$product->id}})"
                                ...
                                <span wire:loading.remove wire:target="agregarAlCarrito({{$product->id}})">Agregar al carrito</span>
                                <span wire:loading wire:target="agregarAlCarrito({{$product->id}})" class="hidden">Agregando...</span>
                            </button>
                        </div>
                    </div>
                </div>
