                    ...
                    <div class="rounded p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                        ...
                        <div>
                            ...
                            <div class="flex justify-between ">
                                <span class="inline-block text-lg font-bold text-blue-400 ">&#8377; {{Number::currency(100000,'COL')}}</span>
                                <span class="inline-block text-lg font-bold text-blue-400 ">&#8377; {{Number::currency(10000000,'COL')}}</span>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3" wire:key="{{$product->id}}">
                                <div class="border border-gray-300 dark:border-gray-700">
                                    ...
                                    <div class="p-3 ">
                                        ...
                                        <p class="text-lg ">
                                            <span class="text-green-600 dark:text-green-600">{{Number::currency($product->price,'COL')}}</span>
                                        </p>
                                    </div>
                                    <div class="flex justify-center p-4 border-t border-gray-300 dark:border-gray-700">
                                        ...
                                        <a href="#" wire:click.prevent="addToCart({{$product->id}})"
                                            ...
                                            </svg><span wire:target="addToCart({{$product->id}})" wire:loading.remove>Agregar al carrito</span> <span wire:loading wire:target="addToCart({{$product->id}})" class="hidden">Agregando...</span>
                                        </a>
