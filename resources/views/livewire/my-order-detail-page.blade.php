<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
    <h1 class="text-4xl font-bold text-slate-500">Detalles de la orden</h1>
                ...
                <table class="w-full">
                    <thead>
                        <tr>
                            ...
                            <th class="text-left font-semibold">Cantiad</th>
                            ...
                            <tr wire:key="{{$order_item->id}}">
                                <td class="py-4">
                                    <div class="flex items-center">
                                        <img class="h-16 w-16 mr-4" src="{{url('storage',$order_item->product->images[0])}}" alt="{{$order_item->product->name}}">
                                        <span class="font-semibold">{{$order_item->product->name}}</span>
                                    </div>
                                </td>
                                <td class="py-4">{{Number::currency($order_item->unit_amount,'COL')}}</td>
                                <td class="py-4">
                                    <span class="text-center w-8">{{$order_item->quantity}}</span>
                                </td>
                                <td class="py-4">{{Number::currency($order_item->total_amount,'COL')}}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
        ...
        <div class="md:w-1/4">
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="flex justify-between mb-2">
                    <span>Subtotal</span>
                    <span>{{Number::currency($order->grand_total,'COL')}}</span>
                </div>
                <div class="flex justify-between mb-2">
                    <span>Taxes</span>
                ...
                <div class="flex justify-between mb-2">
                    ...
                    <span class="font-semibold">{{Number::currency($order->grand_total,'COL')}}</span>
                </div>
